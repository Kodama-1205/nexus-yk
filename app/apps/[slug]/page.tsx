 ...
 * Phase 2 で DB 化した場合も、この関数の戻り値生成だけ差し替えれば運用しやすいです。
 */
...
/**
 * 詳細ページのメタデータです（OG 等の基礎情報）。
 * slug が不正な場合は一覧側に寄せたいので、タイトルのみ最小表示にします。
 */
export function generateMetadata({ params }: AppDetailPageProps) {
